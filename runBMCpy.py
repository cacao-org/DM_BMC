...
dmptt       = shm("dmptt", verbose=False)     # initialize the shm containing piston tip and tilt values 
dm_command  = np.zeros(111, dtype=np.float64) # command sent to MEMS must be a double
